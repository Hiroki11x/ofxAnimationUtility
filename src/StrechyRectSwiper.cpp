...
//    update();
    ...
    switch (mode) {
        ...
        case SwipeMode::SemiCircle:
            ...
            //[2]外部の円
            ofSetColor(color,ofRandom(255));
            ofCircle(ofGetWidth()/2, ofGetHeight(), start_y*1.5);
            ofSetColor(0);
            ofCircle(ofGetWidth()/2, ofGetHeight(), start_y*1.3);
            ...
            //[1]内部の円
            ofCircle(ofGetWidth()/2, ofGetHeight(), start_y*1.1);
            ofSetColor(0);
            ofCircle(ofGetWidth()/2, ofGetHeight(), start_y*0.9);
